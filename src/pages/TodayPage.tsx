...
import { formatPlanDate, greetingForNow, isInCurrentWeek, todayISO } from '../lib/date'
...
export function TodayPage() {
  ...
  const loggedRun = workout
    ? activeRuns.find((run) => run.plannedWorkoutId === workout.id)
    : activeRuns.find((run) => run.runDate === today && run.plannedWorkoutId) ?? activeRuns.find((run) => run.runDate === today)
